...
function cardState(r: DiscoveryItem, lang: Lang): CardState {
  ...
  // الإغلاق أصلًا؛ فلا خبر يُفقد. (٢) الإيقاف لا يُلغى تلقائيًّا بينما
  ...
  // «مغلق» تحت العنوان و«ممتلئ» في الكبسولة توحيان بأنه يعمل وامتلأ.
  if (r.frozenReason) {
    return {
      ...
      // نفس نبرة «مغلق الآن» تمامًا: كبسولةٌ هادئة بحدٍّ لا مساحةٌ مصمتة
