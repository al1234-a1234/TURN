          ...
          <div className="space-y-2.5">
            ...
            {myGifts.map((r) => (
              <div key={r.id} className="rq-card p-4">
                ...
                <div className="mt-3 rounded-2xl px-3 py-2 text-center text-xs font-bold text-brand-800" style={{ background: "rgba(102,28,10,0.08)", border: "1px solid var(--brand-d)" }}>
                  {qrOpen === r.id
