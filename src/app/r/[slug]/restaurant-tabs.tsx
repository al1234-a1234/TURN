    ...
    <div>
            ...
            {reviews.map((rv, i) => (
              <li key={i} className="rq-card p-5">
                <div className="flex items-center gap-3">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full font-display text-base font-bold text-brand-800" style={{ background: "rgba(102,28,10,0.08)", border: "1.5px solid var(--brand-d)" }}>
                    {rv.name.charAt(0)}
                  </span>
                  <div className="min-w-0 flex-1 text-right">
      ...
      <div className={tab === "media" ? "space-y-4" : "hidden"}>
        ...
        <div className="rq-card p-8 text-center">
          <span className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full text-2xl" style={{ background: "rgba(102,28,10,0.08)", border: "1.5px solid var(--brand-d)" }}>🔔</span>
