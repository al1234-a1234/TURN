  ...
  return (
    <>
      ...
      {/* ٤ث لا ١٠: الاستقبال والعميل طرفا نفس الطابور، وكان أحدهما يرى تحرّك
          ...
          و٤ث هي فترة **الحالة الأسوأ** لا الفترة الدائمة: حين يؤكّد الخادم
          اشتراك Realtime تسترخي إلى ٣٠ث، فالتغيير يصل مدفوعًا لا مُستطلَعًا.
          وإن سقطت القناة عادت إلى ٤ث فورًا — فلا يصير الاستقبال أبطأ ممّا
          كان في أيّ حال. */}
      {activeBranch && (
        <AutoRefresh
