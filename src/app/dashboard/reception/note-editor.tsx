  ...
  if (!open) {
    return (
      <button
        ...
        className="mt-1 inline-flex w-full items-center gap-1 truncate text-start text-[11px] font-bold transition"
  ...
  return (
    <div className="mt-1 flex items-center gap-1.5">
      <input
        ...
        onBlur={save}
        disabled={pending}
        placeholder={tr(lang, "مثلاً: اتصلنا، يبي نص ساعة", "e.g. called, wants 30 min")}
        maxLength={140}
        className="w-full rounded-lg border border-[var(--hairline)] px-2 py-1 text-[11px] font-bold outline-none"
