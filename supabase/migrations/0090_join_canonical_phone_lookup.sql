-- ════ تحصين الإطلاق (٣/٣): الانضمام يبحث بالرقم المقيَّس ════
--
-- 0088 جعل الكتابة تُقيَّس. ولو تُرك البحث خامًّا لصار الأمر أسوأ لا أحسن:
-- من ينادي بـ«+966…» لا يجد صفّه المقيَّس، فيحاول إنشاء صفٍّ جديد فيصطدم
-- بالفهرس الفريد، ثم يبحث بالخام مرّةً أخرى فلا يجد — فيدخل بمعرّف عميلٍ
-- فارغ في عمودٍ NOT NULL. الطرفان يجب أن يقيسا بمسطرةٍ واحدة.
--
-- الدالّة كما هي حرفيًّا، بزيادة كتلة التقييس بعد التحقّق من المدخلات.
...
begin
    ...
    -- صيغةٌ واحدة للرقم في كل الجدول: «+966 50…» و«٠٥٠…» و«050…» شخصٌ واحد
