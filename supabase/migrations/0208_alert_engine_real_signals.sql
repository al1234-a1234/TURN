-- ⛔ لا تُطبِّق هذا الملفّ بصيغته الحاليّة.
--
--  طُبِّق على الإنتاج في ٢ سبتمبر فأسقط أربعة حرّاس في run_critical_checks
--  (w10_alerts_new_keys_wired · w11_net_queue_wired · w13_pgnet_selfrestart ·
--  w14_client_errors_wired)، وتُرووجع فورًا بـ٠٢٠٩ فعاد ٢٢٩/٢٢٩.
--
--  السبب: أربعةُ حرّاس تفتّش نصّ send_platform_alerts نفسه بـlike، وإعادةُ
--  كتابته أسقطت النصوص. ولم يظهر على المحاكاة لأنّها لا تملك البطاريّة.
--
--  وأخطرها w13: أسقط هذا الملفّ net.worker_restart() — وهو شفاءٌ ذاتيّ حقيقيّ
--  يفكّ تكدّس طابور إرسال التنبيهات. فقدانُ قدرة لا تنظيف، ويجب أن يعود.
--
--  التصحيح موقوفٌ على قرار المالك (انظر incident-0208).
-- ============================================================================
