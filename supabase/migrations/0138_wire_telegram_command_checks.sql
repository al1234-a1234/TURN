-- ============================================================================
--  شبكة الفحوص تلحق بالبوت ذي الاتجاهين (0137).
--
--  0137 أضاف telegram_command — فكسر q20_schema_no_drift فورًا (١٣٣ → ١٣٤).
--  وهذا هو الفحص يعمل كما يجب: بصمة المخطّط تحرّكت فصرخ. فالواجب تحديث
--  المرجع عمدًا، لا إسكات الفحص.
--
--  وفحصان جديدان يحرسان ما أضافه 0137:
--    w20_telegram_cmd_locked — دالّة الأوامر مسحوبةٌ من anon و authenticated.
--      وهي الأخطر في المشروع: تُقفل الفروع وتقرأ عبر المستأجرين. ولو منحتها
--      امتيازات Supabase الافتراضية للضيف يومًا (كما حدث فعلًا مع
--      staff_branch_queue في 0135) لصار أي زائرٍ يقفل مطاعم الناس.
--    w20_digest_not_flooding — الملخّص مرّتين يوميًّا لا ٤٨. عودةُ */30
--      لا تكسر شيئًا تقنيًّا، لكنها تُعيد تعليم المالك تجاهلَ رسائل البوت —
--      وذلك يُبطل قيمة التنبيهات كلّها.
-- ============================================================================
