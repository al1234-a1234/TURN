-- ============================================================================
--  تحديث run_critical_checks() ليطابق critical_checks.sql بعد 0135 —
--  فحصان جديدان (w19_*) يحرسان سياق العميل على بطاقة الاستقبال: الدالّة
--  موصولةٌ فعليًّا بـcustomer_restaurant (لا إعدادٌ ميّت)، ومحجوبة عن anon.
--  الحاجة الحقيقية: 0135 أعاد إنشاء staff_branch_queue بـDROP/CREATE (تغيّر
--  شكل الإرجاع)، وامتيازات Supabase الافتراضية منحت anon تنفيذها للحظة —
--  اكتُشف حيًّا وأُغلق فورًا؛ هذا الفحص يمسك عودته صامتًا مستقبلًا.
-- ============================================================================
