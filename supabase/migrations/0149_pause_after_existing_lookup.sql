-- ============================================================================
--  إصلاح انحدارٍ أدخلَه 0148 — والدرس أهمّ من الرقعة.
--
--  ✅ مطبَّق على الإنتاج ٣٠ أغسطس.
--
--  ── ما كسرتُه ──
--  وضعتُ حارس `queue_paused` **قبل** استعادة الدور القائم. فعميلٌ هو في
--  الطابور فعلًا، يعيد الإرسال (جوّالٌ آخر، تخزينٌ محذوف، إعادة تحميل)،
--  يُرفض بـP0011 «لا يوجد انتظار» — وهو واقفٌ ورقمه ٣.
--
--  ولم أره حين كتبتُ 0148: اختبرتُ «عميل جديد يُرفض» و«الطابور لا يُشطب»،
--  ولم أختبر «عميلٌ قائمٌ يعيد الإرسال». أمسكه سؤال المالك: «تأكّد أنّ
--  queue_paused لم يكسر السقف ولم يتعارض معه» — فكشف الفحصُ ما لم يُسأل عنه.
--
--  ── لماذا الترتيب هو كلّ شيء ──
--  السطر الذي يسبقه معلَّلٌ منذ 0133: «عميلٌ منضمٌّ أصلًا: نُعيد دوره القائم
--  لا نرفضه بسقفٍ امتلأ بعده». والمنطق نفسه ينطبق حرفيًّا على الإيقاف —
--  فحارسٌ للجدد وُضع في طريق القدماء.
--
--  ── ولماذا ترحيلٌ مستقلّ لا تعديلٌ صامتٌ في 0148 ──
--  0148 مطبَّقٌ على الإنتاج. تعديله في مكانه يجعله يكذب على من يقرأ تاريخ
--  المشروع: سيرى ترحيلًا صحيحًا ولن يعرف أنّ خطأً وقع وأُصلح.
--
--  ── وأثرٌ على القلب القادم ──
--  المالك طلب عكس المنطق (الطابور مغلقٌ افتراضًا). ولو عُكس قبل هذا الإصلاح
--  لصار العطب **هو الحالة الطبيعيّة** لا حالةً نادرة: كلّ فرعٍ موقوفٌ
--  افتراضًا، فكلّ عميلٍ قائمٍ يعيد الإرسال يُرفض. الإصلاح شرطٌ للقلب.
--
--  ── ما اختُبر بعده (فرع المراقبة) ──
--    انضمام عاديّ                ⇒ الدور ١
--    موقوف + عميل قائم          ⇒ ✅ استعاد دوره ١
--    موقوف + عميل جديد          ⇒ ✅ P0011
--    موقوف + سقف ممتلئ + جديد   ⇒ ✅ P0011 (الإيقاف يسبق السقف)
--    سقف ممتلئ وحده + جديد      ⇒ ✅ P0010 «الطابور ممتلئ حاليًا»
--    مقفل + موقوف + ممتلئ       ⇒ ✅ P0003 «الفرع مغلق حاليًا»
--  و١٩٩/١٩٩ فحصًا بعده.
--
--  ⚠️ ملاحظة منهجيّة: أوّل تشغيلٍ أعطى P0429 في حالة «موقوف + قائم» — وهو
--  حدّ المعدّل (٣ محاولات/١٠ دقائق) لا حارس الإيقاف: تلوّثُ تجربةٍ سابقة لا
--  نتيجة. أُعيد برقمٍ نظيف بعد تفريغ `rate_limits`. ولو قُرئ الأوّل نتيجةً
--  لاستُنتج عطبٌ لا وجود له — أو، أسوأ، لأُخفي العطب الحقيقيّ خلفه.
--
--  ── الفرق عن 0148: كتلة `v_paused` انتقلت من قبل استعلام «الدور القائم»
--     إلى بعده. لا شيء آخر تغيّر. ──
-- ============================================================================
