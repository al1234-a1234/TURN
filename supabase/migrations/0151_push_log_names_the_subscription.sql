...
--
--  ✅ مطبَّق على الإنتاج ٣٠ أغسطس بإذن المالك.
--
--  ── ما أُثبت بعده بمخرَجٍ حقيقيّ، لا بظنّ ──
--  ٢٠٢/٢٠٢ فحصًا (كانت ٢٠١/٢٠١) · الدوالّ ١٤٠ بلا تغيير · `push_log_server_only`
--  أخضر (لم تُسقط صلاحية) · `notifications` ٦٨ صفًّا قبل وبعد.
--
--  واختبارٌ حيٌّ بلا كتابة (الكتابة داخل كتلةٍ فرعيّة ثمّ تُلغى بالرفع):
--    أُدرج بالدالّة        = ١
--    payload المكتوب       = {"sub": "93944176-…", "host": "web.push.apple.com"}
--    sub = مُعرّف الاشتراك = true
--    النقطة غير محفوظة     = true
--    صافي المكتوب          = ٠   (٦٨ → ٦٨)
--
--  ── العطب ──
